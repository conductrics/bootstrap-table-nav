...
(function() {
  (function($) {
    ...
    alignTable = function(options) {
      var numCol, parent, rowSelector, rowsToAdd;
      ...
      return parent.append(Array(rowsToAdd + 1).join('<tr' + rowSelector + '><td colspan="' + numCol + '">&ensp;</td></tr>'));
    };
